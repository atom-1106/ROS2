...
/*!
 * @file messagePubSubTypes.hpp
 * This header file contains the declaration of the serialization functions.
 *
 * This file was generated by the tool fastddsgen (version: 4.1.0).
 */

#ifndef FAST_DDS_GENERATED__CAT_MIDDLEWARE_MESSAGE_PUBSUBTYPES_HPP
#define FAST_DDS_GENERATED__CAT_MIDDLEWARE_MESSAGE_PUBSUBTYPES_HPP
...
#error Generated message is not compatible with current installed Fast DDS. Please, regenerate it with fastddsgen.
...
{
public:
	typedef ::cat::middleware::Message type;
...
#endif  // FAST_DDS_GENERATED__CAT_MIDDLEWARE_MESSAGE_PUBSUBTYPES_HPP
